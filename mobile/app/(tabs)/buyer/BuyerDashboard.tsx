...
export default function BuyerDashboard() {
  ...
  const handleMapPress = async (listing: any) => {
    try {
  ...
  const confirmPurchase = async (method: 'cash' | 'card', cardInfo?: { number: string }) => {
    ...
    try {
      ...
      const orderData = {
        ...
        paymentLast4: method === 'card' && cardInfo ? cardInfo.number.replace(/\s/g, '').slice(-4) : null,
  ...
  const handleCardPayment = () => {
    ...
    setPurchaseLoading(true);
    setTimeout(() => {
      confirmPurchase('card', { number: cleanNumber });
    }, 2000);
  };
  ...
  return (
    <View style={styles.mainContainer}>
            ...
            <View style={styles.btnRow}>
              ...
              >
                <Ionicons 
                  ...
                  style={{ marginRight: 4 }}
                />
                <Text style={{ fontSize: 13 }}>Map</Text>
              </TouchableOpacity>
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor:'white' }}>
          ...
          <View style={{
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={{ 
                ...
                {selectedListing?.wasteType} waste
              </Text>
            </View>
          </View>
          ...
          {buyerLocation && sellerLocation && (
            ...
            >
              ...
              {/* Seller bin - green marker */}
              <Marker
                coordinate={sellerLocation}
                title={selectedListing?.sellerName + "'s Bin"}
                description={
          ...
          <View style={{
            ...
            >
              ...
              <Text style={{ 
                ...
                Buy Now · Rs {selectedListing?.totalPrice}
              </Text>
            </TouchableOpacity>
          </View>
      ...
      >
        ...
        >
          {/* Stop tap from closing when 
              tapping inside modal */}
          <TouchableOpacity 
            activeOpacity={1}
            onPress={() => {}}
            style={{
            ...
            >
              ...
              {paymentMethod === 'card' && (
                <View style={{ marginTop: 10 }}>
                  <Text style={[styles.inputLabel, { marginBottom: 10 }]}>Card Details</Text>
              ...
              <TouchableOpacity
                ...
                disabled={!paymentMethod || purchaseLoading}
                style={{
