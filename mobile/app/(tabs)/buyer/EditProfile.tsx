...
export default function BuyerEditProfile() {
  ...
  const [name, setName] = useState("Green Recycling");
  const [email, setEmail] = useState("contact@greenrecycle.lk");
  const [phone, setPhone] = useState("+94 11 234 5678");
  const [location, setLocation] = useState("Colombo, Sri Lanka");

  const handleSave = () => {
    Alert.alert("Success", "Buyer profile details have been updated! ✅");
    router.back(); 
  };
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.formCard}>
        ...
        <View style={styles.inputContainer}>
          <Ionicons name="business-outline" size={20} color="#4F772D" style={styles.icon} />
